...
<body>
	...
	<div style="position: relative; top: 35px; left: 10px;">
		<a href="${pageContext.request.contextPath}/customerLinkman/list?custId=${cutomerLinkman.custId}"><span class="glyphicon glyphicon-arrow-left" style="font-size: 20px; color: #DDDDDD"></span></a>
	</div>
	
	<!-- 大标题 -->
	<div style="position: relative; left: 40px; top: -30px;">
		<div class="page-header">
			<h3>${cutomerLinkman.linkmanName} <small> - ${cutomerLinkman.customer.custName}</small></h3>
		</div>
	...
	<div style="position: relative; top: -70px;">
		<div style="position: relative; left: 40px; height: 30px;">
			...
			<div style="width: 300px;position: relative; left: 200px; top: -20px;"><b>${cutomerLinkman.creator.employeeName}</b></div>
