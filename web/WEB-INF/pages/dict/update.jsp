...
<body>
<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/dict/saveUpdate" method="get">
	<div>
	...
	<div class="form-group">
		...
		<div class="col-sm-10" style="width: 300px;">
			<input name="dictValue" value="${dictionary.dictValue}" type="text" class="form-control" id="create-dicValue" style="width: 200%;">
            <%--<input type="hidden" name="currentDictTypeId" value="${DictionaryType.dictTypeId}">--%>
            <input type="hidden" name="dictId" value="${dictionary.dictId}">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-10" style="width: 300px;">
			<input name="dictOrder" value="${dictionary.dictOrder}" type="text" class="form-control" id="create-orderNo" style="width: 200%;">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-10" style="width: 300px;">
			<input type="radio" name="dictStatus" value="1" ${dictionary.dictStatus==1?"checked='checked'":""} class="form-control"><span style="color: green">启用</span>
            <input type="radio" name="dictStatus" value="2" ${dictionary.dictStatus==2?"checked='checked'":""} class="form-control"><span style="color: red">禁用</span>
        </div>
	</div>
</form>
